...
chao
#Save a copy of the plot
ggsave("../figures/WRC18_Rhizo/chao1.png", plot=chao, device=NULL, path=NULL, scale=1, width=6.3, height=4.4, dpi=900, limitsize=TRUE,bg="transparent")
...
ggsave("../figures/WRC18_Rhizo/shannon.png", plot=shan, device=NULL, path=NULL, scale=1, width=6.3, height=4.4, dpi=900, limitsize=TRUE, bg="transparent")
```
