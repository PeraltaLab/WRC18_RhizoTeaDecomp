...
#adonis2 = adonis(new.data.t[,-c(1:16)]~Percent_Loss, method = "bray", data = new.data.t, perm=1000)
#adonis2 - same as RDA R2
```
...
ggsave("../figures/Ordination_tea.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
...
TBI
ggsave("../figures/TBI.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
...
ggsave("../figures/PercentLoss_boxplots.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
...
ggsave("../figures/alpha_diversity.png", plot=last_plot(), device=NULL, path=NULL, scale=1,  width=8, height=15, dpi=300, limitsize=TRUE)
```
...
xlab("PCoA 1 (43.3%)") + ylab("PCoA 2 (10.6%)") +
  ...
  guides(colour = guide_legend(override.aes = list(pch=16, size = 4)),
         shape = guide_legend(override.aes = list(size = 4)))
ggsave("../figures/Ordination_bulk_tea.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
...
write.csv(t(by_treatment), file = "../figures/soil_properties.csv",row.names=TRUE)
