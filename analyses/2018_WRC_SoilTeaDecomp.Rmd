...
write.csv(wrc_family, file="gamma_composition.csv", row.names=TRUE)
...
write.csv(wrc_family, file="beta_composition.csv", row.names=TRUE)
...
write.csv(wrc_family, file="actino_composition.csv", row.names=TRUE)
...
write.csv(wrc_family, file="rhodo_composition.csv", row.names=TRUE)
