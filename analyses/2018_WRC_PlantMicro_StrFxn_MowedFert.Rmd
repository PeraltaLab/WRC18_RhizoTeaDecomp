...
explainvar2b #18.8
```
```{r Ordination (PCoA) - fungi, include=FALSE}
...
```{r diversity metrics - fun calculate diversity and evenness}
...
```{r diversity metrics - fungal display shannon }
...
```{r Ordination (PCoA) - plant plot, include=FALSE}
...
```{r diversity metrics - bact calculate diversity and evenness}
# Calculate diversity metrics
...
```{r Ordination (PCoA) - Bacteria plot, include=FALSE}
# Principal Coordinates Analysis
...
mantel.rtest(dist.plant, dist.bac, nrepet = 999) #all treatments and ditch included - Mantel r = 0.692, p = 0.004
mantel.rtest(dist.plant.M, dist.bac.M, nrepet = 999) # mowed only: Mantel r = 0.286, p = 0.277
mantel.rtest(dist.plant.MF, dist.bac.MF, nrepet = 999) # mowed/fert: Mantel r = 0.115, p = 0.367
